...
vim.api.nvim_set_keymap('n', '[e', [[<Cmd> lua require'lspsaga.diagnostic'.diagnostic_jump_next()<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', ']e', [[<Cmd> lua require'lspsaga.diagnostic'.diagnostic_jump_prev()<CR>]], { noremap = true, silent = true })
