...
_G.packer_plugins = {
  ...
  ["git-blame.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/chell/.local/share/nvim/site/pack/packer/opt/git-blame.nvim"
  },
  ["gitsigns.nvim"] = {
  ...
  hop = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/chell/.local/share/nvim/site/pack/packer/opt/hop"
  },
  ...
  ["nvim-compe"] = {
    ...
    config = { "\27LJ\2\nì\2\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\vsource\1\0\b\14ultisnips\2\nvsnip\2\vbuffer\2\tpath\2\tcalc\2\rnvim_lua\2\rnvim_lsp\2\fluasnip\2\1\0\15\19max_kind_width\3d\19max_abbr_width\3d\ndebug\1\20resolve_timeout\3 \6\19source_timeout\3È\1\18throttle_time\3P\14preselect\venable\15min_length\3\1\17map_complete\2\vmap_cr\2\17autocomplete\2\fenabled\2\21incomplete_delay\3\3\18documentation\2\19max_menu_width\3d\nsetup\ncompe\frequire\0" },
    loaded = false,
    needs_bufread = false,
  ...
  ["nvim-lspinstall"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/chell/.local/share/nvim/site/pack/packer/opt/nvim-lspinstall"
  },
  ["nvim-spectre"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'numb.nvim', 'hop', 'nvim-lspinstall', 'nvim-spectre', 'git-blame.nvim', 'indent-blankline.nvim', 'lsp-colors.nvim', 'todo-comments.nvim', 'lspsaga.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
